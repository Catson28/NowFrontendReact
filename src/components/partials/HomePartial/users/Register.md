        ...
        <FormLeft>
          <FormLeftContent>
            ...
            <Text className="text-1">
              Bem-vindo ao nosso marketplace! Aqui você encontrará uma ampla
              variedade de serviços à sua disposição. Antes de prosseguir com o
              cadastro, leia as informações abaixo com atenção.
            </Text>
            <Text className="text-2">
              <span>Importante:</span> Forneça informações precisas e
              atualizadas para garantir um processo de cadastro rápido e sem
              complicações. Estamos aqui para ajudar em caso de dúvidas.
            </Text>
            <FormLeftLast>
              <SubmitButton
                type="submit"
